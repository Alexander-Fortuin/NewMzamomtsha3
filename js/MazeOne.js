...
class Maze {
  ...
  constructor(cols, rows, cellSize) {
    ...
    this.backgroundColor = "#9abad6";
    this.cols = cols;
    this.endColor = "#4e84b5";
    this.mazeColor = "#fff";
    //this.playerColor = "#c1d5e6";
    this.playerColor = "#f4f4f4";
    this.rows = rows;
...
function onClick(event) {
  ...
  maze.generate();
  player = new Player();
  document.getElementById("TheMaze").style.paddingTop = "50px";
}
function intermediate(event) {
  ...
  maze.generate();
  player = new Player(); 
  document.getElementById("TheMaze").style.paddingTop = "40px";
}
function hard(event) {
  maze.cols = 23;
  maze.rows = 23;
  maze.generate();
  player = new Player(); 
  document.getElementById("TheMaze").style.paddingTop = "0px";
}
